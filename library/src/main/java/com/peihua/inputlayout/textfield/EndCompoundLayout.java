...
import static com.peihua.inputlayout.textfield.IconHelper.applyIconTint;
import static com.peihua.inputlayout.textfield.IconHelper.convertScaleType;
import static com.peihua.inputlayout.textfield.IconHelper.refreshIconDrawableState;
import static com.peihua.inputlayout.textfield.IconHelper.setCompatRippleBackgroundIfNeeded;
import static com.peihua.inputlayout.textfield.IconHelper.setIconMinSize;
import static com.peihua.inputlayout.textfield.IconHelper.setIconOnClickListener;
import static com.peihua.inputlayout.textfield.IconHelper.setIconOnLongClickListener;
import static com.peihua.inputlayout.textfield.IconHelper.setIconScaleType;
...
class EndCompoundLayout extends LinearLayout {
    ...
    private int endIconMode = TextInputLayout.END_ICON_NONE;
    ...
    @NonNull
    private ScaleType endIconScaleType;
    ...
    private void initEndIconView(TintTypedArray a) {
        ...
        if (a.hasValue(R.styleable.TextInputLayout_endIconMode)) {
            ...
            setEndIconMode(a.getInt(R.styleable.TextInputLayout_endIconMode, TextInputLayout.END_ICON_NONE));
            ...
            setEndIconMode(passwordToggleEnabled ? TextInputLayout.END_ICON_PASSWORD_TOGGLE : TextInputLayout.END_ICON_NONE);
            setEndIconContentDescription(
    ...
    void setEndIconMode(@TextInputLayout.EndIconMode int endIconMode) {
        ...
        setEndIconVisible(endIconMode != TextInputLayout.END_ICON_NONE);
    ...
    boolean hasEndIcon() {
        return endIconMode != TextInputLayout.END_ICON_NONE;
    }
    ...
    boolean isPasswordVisibilityToggleEnabled() {
        return endIconMode == TextInputLayout.END_ICON_PASSWORD_TOGGLE;
    }

    void setPasswordVisibilityToggleEnabled(boolean enabled) {
        if (enabled && endIconMode != TextInputLayout.END_ICON_PASSWORD_TOGGLE) {
    ...
    private void updateEndLayoutVisibility() {
        ...
        boolean shouldBeVisible =isShowCustomView()||
                isEndIconVisible() || isErrorIconVisible() || suffixTextVisibility == VISIBLE;
        setVisibility(shouldBeVisible ? VISIBLE : GONE);
    }

    private void dispatchOnEndIconChanged(@TextInputLayout.EndIconMode int previousIcon) {
        for (TextInputLayout.OnEndIconChangedListener listener : endIconChangedListeners) {
    ...
    private boolean isShowCustomView() {
        return customView != null && customView.getVisibility() == VISIBLE;
    }
    ...
    private static class EndIconDelegates {
        ...
        EndIconDelegate get(@TextInputLayout.EndIconMode int endIconMode) {
