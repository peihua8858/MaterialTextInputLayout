...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
  ...
  public void onEditTextAttached(@Nullable EditText editText) {
    ...
    if (!EditTextUtils.isEditable(editText) && accessibilityManager.isTouchExplorationEnabled()) {
  ...
  public void afterEditTextChanged(Editable s) {
    ...
    if (accessibilityManager.isTouchExplorationEnabled()
        && EditTextUtils.isEditable(autoCompleteTextView)
  ...
  public void onPopulateAccessibilityEvent(View host, @NonNull AccessibilityEvent event) {
    if (!accessibilityManager.isEnabled() || EditTextUtils.isEditable(autoCompleteTextView)) {
      return;
    }
